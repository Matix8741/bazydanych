...
SELECT Ulica FROM Lokalizacja INNER JOIN Podmiot ON ID_Lokalizacji = ID_Lokalizacja GROUP BY Ulica , NrBudynku , Miasto , KodPocztowy ORDER BY COUNT (*)
SELECT NrBudynku FROM Lokalizacja INNER JOIN Podmiot ON ID_Lokalizacji = ID_Lokalizacja GROUP BY Ulica , NrBudynku , Miasto , KodPocztowy ORDER BY COUNT (*)
SELECT Miasto FROM Lokalizacja INNER JOIN Podmiot ON ID_Lokalizacji = ID_Lokalizacja GROUP BY Ulica , NrBudynku , Miasto , KodPocztowy ORDER BY COUNT (*)
SELECT KodPocztowy FROM Lokalizacja INNER JOIN Podmiot ON ID_Lokalizacji = ID_Lokalizacja GROUP BY Ulica , NrBudynku , Miasto , KodPocztowy ORDER BY COUNT (*)
SELECT Kwota FROM Transakcje GROUP BY Kwota ORDER BY COUNT(*)

SELECT Ulica FROM Lokalizacja INNER JOIN Podmiot ON ID_Lokalizacji = ID_Lokalizacja GROUP BY Ulica ORDER BY COUNT (*)
SELECT NrBudynku FROM Lokalizacja INNER JOIN Podmiot ON ID_Lokalizacji = ID_Lokalizacja GROUP BY NrBudynku ORDER BY COUNT (*)
SELECT Miasto FROM Lokalizacja INNER JOIN Podmiot ON ID_Lokalizacji = ID_Lokalizacja GROUP BY Miasto ORDER BY COUNT (*)
SELECT KodPocztowy FROM Lokalizacja INNER JOIN Podmiot ON ID_Lokalizacji = ID_Lokalizacja GROUP BY KodPocztowy ORDER BY COUNT (*)
